    ...
    public partial class finalDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    departure = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ...
                    passengerUN = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    orderTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    numberOfPassengers = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Biletler", x => new { x.departure, x.destination, x.date, x.AirLine, x.passengerUN, x.orderTime });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ucaklar", x => new { x.departure, x.destination, x.date, x.AirLine });
                });
